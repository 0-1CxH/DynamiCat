...
class GeneralDatasetTokenizer:
    def __init__(self, tokenizer):
        ...
        self.tokenize_function = tokenizer.__call__
    ...
    def dataset_to_tensors(self, dataset: GeneralDataset):
        for record in dataset.iterate():
            for field, tokenization_configs in zip(record, dataset.make_tokenization_configs()):
                yield self.text_to_tensor(field, **tokenization_configs)
