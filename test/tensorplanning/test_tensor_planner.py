...
from dynamicat.tensorplanning.tensor_plan_base import GeneralTensorPlan
...
tp3 = TensorPlannerFactory.create_tensor_planner(plan_type="LengthDifferenceRestricted", max_token_diff=16,
                                                 max_plan_size=64, primary_key="prompt")
tp4 = TensorPlannerFactory.create_tensor_planner(plan_type="MaxLengthRestricted", max_field_length=1024, batch_size=4,
                                                 primary_key="content")
...
if __name__ == '__main__':
    ...
    for _ in [plan1, plan2, plan3, plan4]:
        ...
        print(isinstance(_, GeneralTensorPlan))
